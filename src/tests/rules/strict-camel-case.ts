...
TsEsLintRuleTester.it = function(text, method): void {
    // there are no positive test cases
    it("fails with test cases:\n" + text, method);
};
TsEsLintRuleTester.describe = function(text, method): void {
    describe(text + " @typescript-eslint/rule-tester", method);
};
